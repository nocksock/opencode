...
export type MessageAction = {
  ...
  label: string
  /**
   * Optional description shown in command list
   */
  description?: string
  /**
...
export type Config = {
  ...
  /**
   * Custom message actions that receive session-id and message-id
   */
...
export type MessageActionErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type MessageActionError = MessageActionErrors[keyof MessageActionErrors]

export type MessageActionResponses = {
  /**
...
export type MessageActionResponse = MessageActionResponses[keyof MessageActionResponses]
